...
HelixPiEditor.Play.createScenario = function () {
  return {
    startingPosition: function startingPosition() {
    ...
    fitness: function fitness(entity) {
      var distance = {
...
window.HelixPiEditor = HelixPiEditor;
window.helixPi = helixPi;

},{"helix-pi":6}],2:[function(require,module,exports){
...
},{"./app/breeding":2,"./app/entity":3,"./app/seeder":4,"./app/simulator":5,"lodash":7}],7:[function(require,module,exports){
(function (global){
/**
 * @license
